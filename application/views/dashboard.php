    ...
    <div class="row text-center mt-3">
        ...
        <?php foreach ($barang as $brg) : ?>
            ...
            <div class="card ml-3 mb-3 " style="width: 16rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title ml-1 mb-1"><?php echo $brg->nama_brg ?></h5>
                    <small><?php echo $brg->keterangan ?></small><br>
                    <span class="badge badge-pill badge-success ml-3 mb-3">Rp. <?php echo number_format($brg->harga, 0,',','.') ?></span>
                    <?php echo anchor('dashboard/tambah_ke_keranjang/'.$brg->id_brg,'<div class="btn btn-sm btn-primary mb-3">Tambah ke Keranjang</div>')?>
                    <?php echo anchor('dashboard/detail/'.$brg->id_brg,'<div class="btn btn-sm btn-success mb-3">Detail</div>')?>
                </div>
            </div>
